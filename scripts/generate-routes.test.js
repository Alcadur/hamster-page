describe('scripts/generate-routes', function () {
    ...
    describe('static content', function () {
        ...
        it('should add INDEX as first route', function () {
            require('./generate-routes');
    ...
    describe('flat structure', function () {
        ...
        it('should generate correct routes', function () {
            ...
            expect(fileContentLines[3]).toEqual('export const DIR2 = "/dir2";');
            expect(fileContentLines[4]).toEqual('export const DIR4_WITH_DASH = "/dir4-with-dash";');
        ...
        it('should sort content ascending', function () {
            ...
            expect(fileContentLines).toHaveLength(5);
            expect(fileContentLines[2]).toEqual('export const DIR_AAA = "/dir-aaa";');
            expect(fileContentLines[3]).toEqual('export const DIR_BBB = "/dir-bbb";');
